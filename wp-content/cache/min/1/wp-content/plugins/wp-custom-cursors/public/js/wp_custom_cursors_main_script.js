        ...
        window.addEventListener('load', function(event) {
            ...
            if (frames.length > 0) {
                ...
                if (cursor.activate_on == 0) {
                    ...
                    enableCursorActivationMutation = !0;
